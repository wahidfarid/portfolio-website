        ...
        <div className="left w-full lg:w-3/5 flex flex-col justify-end items-center md:items-start z-10">
          ...
          <div className="flex items-center gap-4 mt-8">
            ...
            <div className="flex gap-3">
              <a href="https://github.com/wahidfarid" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-400 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/in/wahid-magdy-farid" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
